...
module.exports = class extends BaseGenerator {
    ...
    get end() {
        return {
            ...
            // INICIO [MPRO] (CODIGO INCLUIDO => EXECUTA O COMANDO <import-jdl> PASSANDO POR PARAMETRO O JDL <common.jh> QUE GERA TODAS AS CLASSES COMUNS A TODOS SISTEMAS)
            importarjdl(){
                this.spawnCommandSync('jhipster import-jdl', ['common.jh']);                                  
            },
            // FIM [MPRO]
