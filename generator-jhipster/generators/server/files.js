...
const serverFiles = {
    ...
    serverBuild: [
        ...
        // INICIO [MPRO] (CODIGO ALTERADO => INCLUÍDO O ARQUIVO <common.jh>)
        {
            condition: generator => generator.buildTool === 'maven',
            templates: [
                { file: 'common.jh', method: 'copy', noEjs: true},
    ...
    serverJavaDomain: [
        ...
        // INICIO [MPRO] (CODIGO ALTERADO => ACRESCENTANDO A REFERENCIA DOS ARQUIVO ENUMS COMUNS)
        {
            ...
            templates: [
                ...
                {
                    file: 'package/domain/enumeration/ClasseOrgao.java',
                    renameTo: generator => `${generator.javaDir}domain/enumeration/ClasseOrgao.java`
                },
                {
                    file: 'package/domain/enumeration/ContentType.java',
                    renameTo: generator => `${generator.javaDir}domain/enumeration/ContentType.java`
                },
                {
                    file: 'package/domain/enumeration/SituacaoServidor.java',
                    renameTo: generator => `${generator.javaDir}domain/enumeration/SituacaoServidor.java`
                },
                {
                    file: 'package/domain/enumeration/UnidadeFederativa.java',
                    renameTo: generator => `${generator.javaDir}domain/enumeration/UnidadeFederativa.java`
                },
                {
                    file: 'package/domain/enumeration/SimNao.java',
                    renameTo: generator => `${generator.javaDir}domain/enumeration/SimNao.java`
                }
            ]
        }
        // FIM [MPRO]
    ...
    serverJavaService: [
        // INICIO [MPRO] (CODIGO ALTERADO => ACRESCENTADO REFERÊNCIA AOS ARQUIVO SERVICE E EXCEPTION COMUNS)
        {
            path: SERVER_MAIN_SRC_DIR,
            templates: [
                { file: 'package/service/package-info.java', renameTo: generator => `${generator.javaDir}service/package-info.java` },
                { file: 'package/service/util/StringUtil.java', renameTo: generator => `${generator.javaDir}service/util/StringUtil.java` },
                { file: 'package/service/util/LogUtil.java', renameTo: generator => `${generator.javaDir}service/util/LogUtil.java` },
                { file: 'package/exception/AppException.java', renameTo: generator => `${generator.javaDir}exception/AppException.java` }
            ]
        },
        // FIM [MPRO]
        {
