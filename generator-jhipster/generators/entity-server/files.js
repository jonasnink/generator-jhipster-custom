    ...
    server: [
        {
            ...
            templates: [
                // INICIO [MPRO] (CODIGO ALTERADO PARA GERAR/SOBRESCREVER APENAS AS CLASSES DO DIRETÓRIO generated )
                {
                    ...
                    renameTo: generator => `${generator.packageFolder}/domain/generated/${generator.entityClass}Generated.java`
                },
                // FIM [MPRO]
                {
        ...
        writeServerFiles() {
            ...
            if (this.databaseType === 'sql') {
                ...
                if (['ehcache', 'infinispan'].includes(this.cacheProvider) && this.enableHibernateCache) {
                    ...
                    // INICIO [MPRO] (CODIGO INCLUIDO)
                    this.addEntityToCache('generated.'+this.entityClass+'Generated', this.relationships, this.packageName, this.packageFolder, this.cacheProvider);
                    // FIM [MPRO]
                }
            }
        },
