...
const files = {
    ...
    angularMain: [
        ...
        // INICIO [MPRO] (CODIGO ALTERADO => footer.scss)
        {
            condition: generator => generator.useSass,
            path: ANGULAR_DIR,
            templates: ['layouts/profiles/page-ribbon.scss', 'layouts/navbar/navbar.scss', 'layouts/footer/footer.scss', 'home/home.scss']
        },
        // FIM [MPRO]
        // INICIO [MPRO] (CODIGO ALTERADO => footer.css)
        {
            condition: generator => !generator.useSass,
            path: ANGULAR_DIR,
            templates: ['layouts/profiles/page-ribbon.css', 'layouts/navbar/navbar.css', 'layouts/footer/footer.css', 'home/home.css']
        }
        // FIM [MPRO]
    ],
